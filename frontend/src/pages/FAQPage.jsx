          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at I-SHOP@gmail.com with your order number and a brief
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                I-SHOP@gmail.com, or by calling us at +962 796899777
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                you've ordered, you can return them for a refund within two
                weeks of delivery.
              </p>
            </div>
          )}
